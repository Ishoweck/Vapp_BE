...
export class NotificationController {
   ...
   */
  async getPreferences(req: AuthRequest, res: Response<ApiResponse>): Promise<void> {
   ...
   */
  async updatePreferences(req: AuthRequest, res: Response<ApiResponse>): Promise<void> {
